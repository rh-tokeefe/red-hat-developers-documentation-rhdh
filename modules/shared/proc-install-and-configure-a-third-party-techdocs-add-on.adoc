...
* The third-party plugin is packaged as a dynamic plugin in an OCI image. For alternative package types, link:https://redhat-developer.github.io/red-hat-developers-documentation-rhdh/latest/plugins-rhdh-install/index.html[Installing third-party plugins in Red Hat Developer Hub].
