...
[id="install-and-configure-a-third-party-techdocs-add-on_{context}"]
= Install and configure a third-party TechDocs add-on

[role="_abstract"]
You can install a compatible third-party TechDocs add-on on your {product} instance as a front-end dynamic plugin.
...
* The third-party plugin is packaged as a dynamic plugin in an OCI image. For alternative package types, see link:https://redhat-developer.github.io/red-hat-developers-documentation-rhdh/latest/plugins-rhdh-install/#assembly-install-third-party-plugins-rhdh[Installing third-party plugins in {product}].
