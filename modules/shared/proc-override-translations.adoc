...
[id="override-translations_{context}"]
...
.Procedure
. Create a JSON file containing the translation strings that you want to override, as shown in the following example. You can select French, German, Italian, Japanese or Spanish.
+
[id=i18n-enable]
...
* xref:floating-action-button-localization-support_configure-a-floating-action-button-in-rhdh[Enabling floating button localization in {product-short}]
* xref:enable-quick-start-localization-in-rhdh_customize-the-quick-start-plugin[Enable quick start localization in {product-short}]
* xref:enable-sidebar-menu-items-localization-in-rhdh_customize-rhdh-navigation[Enabling sidebar menu items localization in {product-short}]
