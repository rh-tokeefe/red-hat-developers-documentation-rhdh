...
:product-bundle-version: 1.10.1
:product-chart-version: 1.10.1
...
:product-book-title: {product} documentation
:product-book-link: {product-docs-link}/html-single/red_hat_developer_hub_documentation/index
